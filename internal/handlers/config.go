...
var systemConfigDefinitions = []systemConfigDefinition{
	...
	{Key: "MAIL_PASSWORD", Description: "SMTP 授权码/应用密码（非邮箱登录密码，加密存储）", IsSensitive: true},
	...
	{Key: "NEXTCLOUD_URL", Description: "Nextcloud 地址（用于备份上传）"},
	{Key: "NEXTCLOUD_USERNAME", Description: "Nextcloud 用户名（用于备份上传）"},
	{Key: "NEXTCLOUD_PASSWORD", Description: "Nextcloud 应用密码（非登录密码，加密存储）", IsSensitive: true},
